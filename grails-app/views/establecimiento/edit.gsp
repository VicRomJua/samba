...
<html>
    ...
    <body>
		...
		<div class="breadcrumb-box">
		  <div class="container">
			<ul class="breadcrumb">
			  ...
			  <li><g:link action="show" resource="${this.establecimiento}"><g:message code="default.show.label" args="[entityName]" /></g:link></li>
			  <li class="active">${establecimiento.nombre}</li>
			</ul>	
		  </div>
		</div>
		<!-- .breadcrumb-box -->
        <a href="#edit-establecimiento" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-establecimiento" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.establecimiento}" method="PUT">
                <g:hiddenField name="version" value="${this.establecimiento?.version}" />
                <fieldset class="form">
                        ...
                        <div class="x_panel">
                            <div class="x_content">
                                ...
                                <f:field property="administrador">
									<g:select id="administrador" name="administrador" from="${administradores}" optionKey="id" optionValue="nombre" value="${this.establecimiento.administrador?this.establecimiento.administrador.id:''}"/>
								</f:field>
                ...
                <fieldset class="buttons">
                    ...
                    <g:link name="footer-close" class="close" action="show" resource="${this.establecimiento}"><g:message code="default.button.close.label" default="Close" /></g:link>
                </fieldset>
            </g:form>
        </div>
    </body>
