...
<html>
    ...
    <body>
		...
		<!-- .breadcrumb-box -->
        <a href="#create-roleLG" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-roleLG" class="content scaffold-create" role="main">
