...
<html>
    <head>
        ...
        <script language="javascript">
			$( document ).ready(function() {
				$("#establecimiento, #empresa").select2({
					language: "es"
				});				 
			});
    ...
    <body>
		...
		<!-- .breadcrumb-box -->
        <a href="#create-embarque" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-embarque" class="content scaffold-create" role="main">
