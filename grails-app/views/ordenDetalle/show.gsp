...
<html>
    ...
    <body>
		...
		<!-- .breadcrumb-box -->
        <a href="#show-ordenDetalle" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="show-ordenDetalle" class="content scaffold-show" role="main">
			...
			<f:with bean="ordenDetalle">
                <ol class="property-list ordenDetalle">
                    <li class="fieldcontain">
                        <span id="nombre-label" class="property-label"><g:message code="ordenDetalle.nombre.label" default="Nombre" /></span>
            ...
            <g:form resource="${this.ordenDetalle}" method="DELETE" name="delete_form">
				<fieldset class="buttons">
					<g:link name="footer-edit" class="edit" action="edit" resource="${this.ordenDetalle}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
