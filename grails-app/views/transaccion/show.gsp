...
<html>
    ...
    <body>
        ...
        <div id="show-transaccion" class="content scaffold-show" role="main">
            ...
            <f:display bean="transaccion" />
            
            %{--
			<f:with bean="transaccion">
                <ol class="property-list transaccion">
                    <li class="fieldcontain">
                        <span id="nombre-label" class="property-label"><g:message code="transaccion.nombre.label" default="Nombre" /></span>
            ...
            <g:form resource="${this.transaccion}" method="DELETE" name="delete_form">
				<fieldset class="buttons">
					<g:link name="footer-edit" class="edit" action="edit" resource="${this.transaccion}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
