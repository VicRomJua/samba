...
<html>
    ...
    <body>
		...
		<!-- .breadcrumb-box -->
        <a href="#create-transaccion" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-transaccion" class="content scaffold-create" role="main">
