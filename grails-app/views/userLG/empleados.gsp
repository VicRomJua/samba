		...
		<div class="breadcrumb-box">
		  <div class="container">
			<ul class="breadcrumb">
			  ...
			  <li class="active"><g:message code="default.list.label" args="['empleados']" /></li>
			</ul>
		  </div>
		</div>
		<!-- .breadcrumb-box -->
	        ...
	        <div class="nav_topbar" role="navigation">
	            <ul>
	                <div class="col-xs-6 col-xs-offset-2" style="float:right;padding: 0px;">
						...
						<g:form action="empleados" method="POST" name="search_form">
	            ...
	            <table>
	                ...
	                <thead>
	                    <tr>
	                        ...
	                        <g:sortableColumn property="enabled" title="${message(code: 'userLG.enabled.label', default: 'Activo')}" class="celda_centrada"/>
	                    </tr>
	                </thead>
					</g:if>
	                <tbody>
	                    ...
	                    <g:if test="${userLGCount == 0}">
							<tr>
								<td colspan="5" style="text-align:center"></br></br><img src="${request.contextPath}/assets/empty/usuarios.png" border="0px"/></br><span style="font-size:18px;color:#b1b1b1;">No tiene solicitudes pendientes por autorizar.</br>Pida a sus empleados registrarse en la plataforma de Samba Smoothie.</span></br></br></td>
							</tr>
	                    </g:if>
	                </tbody>
	            </table>
