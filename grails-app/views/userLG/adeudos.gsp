		...
		<div class="breadcrumb-box">
		  <div class="container">
			<ul class="breadcrumb">
			  ...
			  <li class="active"><g:message code="default.list.label" args="['adeudos']" /></li>
			</ul>
		  </div>
		</div>
		<!-- .breadcrumb-box -->
	        ...
	        <div class="nav_topbar" role="navigation">
	            <ul>
	                <div class="col-xs-6 col-xs-offset-2" style="float:right;padding: 0px;">
						...
						<g:form action="adeudos" method="POST" name="search_form">
	            ...
	            <table>
	                ...
	                <thead>
	                    <tr>
	                        ...
	                        <g:sortableColumn property="montoAdeudo" title="${message(code: 'userLG.montoAdeudo.label', default: 'Monto adeudado')}" style="width:100px" />
	                    </tr>
	                </thead>
					</g:if>
	                <tbody>
	                    <g:each in="${userLGList}" var="user" status="i">
	                        <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
								...
								<td>
									<g:formatNumber number="${user.montoAdeudo}" format="\$ ###,###,##0.00" />
								</td>
	                        </tr>
	                    </g:each>
	                    <g:if test="${userLGCount == 0}">
