...
class Empresa {
    ...
    static constraints = {
        ...
        giro		    (nullable: false, inList: ["Gobierno Federal", "Gobierno Municipal", "Manufactura", "Educación", "Hoteleria", "Servicios", "Consultoria", "Sector privado", "Salud", "Inmobiliaria", "Comunicación", "Cultural y deportivo", "Comercio", "Otro"])
        noEmpleados		(nullable: false,  min: 0)
