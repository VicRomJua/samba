...
<html>
    ...
    <body>
		...
		<div class="breadcrumb-box">
		  <div class="container">
			<ul class="breadcrumb">
			  ...
			  <li><g:link action="show" resource="${this.platilloEstablecimiento}"><g:message code="default.show.label" args="[entityName]" /></g:link></li>
			  <li class="active">${platilloEstablecimiento.platillo.nombre}</li>
			</ul>	
		  </div>
		</div>
		<!-- .breadcrumb-box -->
        <a href="#edit-platilloEstablecimiento" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-platilloEstablecimiento" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.platilloEstablecimiento}" method="PUT">
                <g:hiddenField name="version" value="${this.platilloEstablecimiento?.version}" />
                <fieldset class="form">
                    %{--
					...
					<f:with bean="platilloEstablecimiento">
                        <div class="x_panel">
                            <div class="x_content">                    
                                ...
                                <f:field property="platillo" wrapper="display"/>
                ...
                <fieldset class="buttons">
                    ...
                    <g:link name="footer-close" class="close" action="show" resource="${this.platilloEstablecimiento}"><g:message code="default.button.close.label" default="Close" /></g:link>
                </fieldset>
            </g:form>
        </div>
    </body>
