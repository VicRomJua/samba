...
<html>
    <head>
        ...
        <g:set var="entitiesName" value="${message(code: 'horarios.label', default: 'Horarios')}" />
    ...
    <body>
		...
		<!-- .breadcrumb-box -->
        <a href="#show-horarios" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="show-horarios" class="content scaffold-show" role="main">
            <g:if test="${flash.message}">
            <div class="message" role="status">${flash.message}</div>
            </g:if>
            <f:display bean="horarios" />
            <g:form resource="${this.horarios}" method="DELETE" name="delete_form">
                <fieldset class="buttons">
					<g:link name="footer-edit" class="edit" action="edit" resource="${this.horarios}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
