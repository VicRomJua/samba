...
<div class="fieldcontain <g:if test="${required}">required</g:if> ${hasErrors(bean: bean, field: property, 'has-error')}" style="height:230px;">
	<g:if test="${value}">
		<img id="${(prefix ?: '') + property}-img" src="${request.contextPath}/assets/mes-icons/${value}" style="width:200px;height:200px;" />
	</g:if>
	<g:else>
		<img id="${(prefix ?: '') + property}-img" src="${request.contextPath}/assets/mes-icons/default.png" style="width:200px;height:200px;" />
	</g:else>
	</br>
