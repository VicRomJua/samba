...
<html>
    ...
    <body>
		...
		<!-- .breadcrumb-box -->
        <a href="#create-ordenDetalle" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-ordenDetalle" class="content scaffold-create" role="main">
